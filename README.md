...
Exact entry logic, stop placement, and target levels are proprietary and not disclosed here.
📁 About This Repository
This repo serves as the public face of QES — architecture overview, system summary, and live track record. The proprietary scoring models, backtest engines, and raw historical datasets that power each system remain private and are not included here.
QES is currently trading its own systems rather than distributing them publicly. Ongoing documentation is shared as trade journaling — real entries, real outcomes, logged as they happen — rather than as a promotional record.
📬 Connect
